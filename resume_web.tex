	...
	\begin{itemize}
		\item 
			\ressubheading{\href{http://www.nagarro.com/}{Software Engineer, Nagarro}}{Jul, 2012 -- Jul, 2015}
				{Ldrive: Java based Web application for a supply chain management system.}{}
				{ \footnotesize
				\begin{itemize}
					\resitem{Implemented data export services in the web-application using Apache poi.}
					\resitem{Designed a multi-transaction based query system for the application to help retrieve large data from database using bounded memory.}
					\resitem{Provided L3 and L4 support service to the client.}
				\end{itemize}
				}	
				

			\ressubsubheading{Quicken: Windows based personal finance management application.}{}{ \footnotesize
				\begin{itemize}
					\resitem{Revamped a custom WIN32 control -- Quickfill and improved it's service via caching and asynchronous data loading.}
					\resitem{Redesigned application controls by writing C++ wrappers over WIN32 implementation; to help facilitate easier debugging and extensibility.}
				\end{itemize}
				}
				
			\ressubsubheading{NTEG: New Technology Exploration group.}{}
				{ \footnotesize
				\begin{itemize}
					\resitem{Implemented a HTML5 canvas and Angular JS based tic-tac-toe app as a PoC project.}
					\resitem{Involved in creating projects to showcase HTML5 and CSS3 features.}
