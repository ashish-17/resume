...
\item[Web based Employee portal:] { \footnotesize Implemented an employee portal application for a call center company as a freelancer project with features including work tracking, shift management, payroll management, holiday/leave management and performance tracking. [Java, Spring, Hibernate,  Apache Tiles, Bootstrap]}
\end{description}
